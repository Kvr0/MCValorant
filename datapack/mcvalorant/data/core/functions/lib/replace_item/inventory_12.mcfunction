#> mcvalorant:lib/replace_item/inventory_12
# アイテムの設定:inventory.12
...
## 置き換え
    item replace entity @s inventory.12 from entity 0000ab6d-0000-0000-0000-000000000001 armor.head
