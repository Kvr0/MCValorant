#> mcvalorant:lib/replace_item/inventory_26
# アイテムの設定:inventory.26
...
## 置き換え
    item replace entity @s inventory.26 from entity 0000ab6d-0000-0000-0000-000000000001 armor.head
